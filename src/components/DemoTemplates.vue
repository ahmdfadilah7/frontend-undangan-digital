    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center space-y-4 mb-16">
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900">
          Demo <span class="gradient-text">Interaktif</span>
        </h2>
        <p class="text-xl text-gray-600 max-w-3xl mx-auto">
          Coba langsung template undangan digital kami dengan fitur interaktif yang sesungguhnya
        </p>
      </div>
      ...
      <div class="mt-16 bg-white rounded-2xl p-8 shadow-lg">
        <div class="text-center mb-8">
          <h3 class="text-2xl font-bold text-gray-900 mb-2">Statistik Demo</h3>
          <p class="text-gray-600">Data real-time dari demo yang telah dicoba</p>
        </div>
        
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <div class="text-3xl font-bold text-primary-600 mb-1">{{ demoStats.totalViews }}</div>
            <div class="text-sm text-gray-600">Total Views</div>
          </div>
          <div>
            <div class="text-3xl font-bold text-secondary-600 mb-1">{{ demoStats.activeUsers }}</div>
            <div class="text-sm text-gray-600">Users Online</div>
          </div>
          <div>
            <div class="text-3xl font-bold text-accent-600 mb-1">{{ demoStats.completedRSVP }}</div>
            <div class="text-sm text-gray-600">RSVP Completed</div>
          </div>
          <div>
            <div class="text-3xl font-bold text-green-600 mb-1">{{ demoStats.sharedCount }}</div>
            <div class="text-sm text-gray-600">Times Shared</div>
          </div>
        </div>
      </div>
    </div>
